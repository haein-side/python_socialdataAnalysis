...
chartdata = data.loc[PRODUCT, WHEN]
...
# 온라인쇼핑몰 취급상품범위별 합계 꺽은선그래프 그리기
chartdata.plot(title='firstGraph')

plt.grid(True)
plt.xlabel('시점', labelpad=15)
plt.ylabel('취급상품범위별 거래량 합계', labelpad=20)
plt.title('온라인쇼핑몰 취급상품범위별 월별 거래량 합계')
